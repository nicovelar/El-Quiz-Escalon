<?php
    ...
    $sql = "SELECT nombre from preguntas_segundoEscalon order by rand() limit 1";
...
<div>
    ...
    $sql = "SELECT respuesta from respuestas_segundoEscalon where pregunta = '$pregunta'  order by rand()" ;
    $result = $conn->query($sql);
   ...
   <a  style="text-decoration:none" class= "display-6 text-white" align="center" href="../../public">Retirarse o Quedarse con $50</a> 
</button> <br> <br>
 ...
 <!-- Respuesta correcta -->   
<?php
    $sql = "SELECT respuesta from preguntas_segundoEscalon where nombre LIKE '$pregunta'";
    $result = $conn->query($sql);
    while ($row = $result->fetch_assoc()) {
