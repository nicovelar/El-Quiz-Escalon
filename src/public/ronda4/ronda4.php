<?php
    ...
    $sql = "SELECT nombre from preguntas_cuartoEscalon order by rand() limit 1";
...
<div>
    ...
    $sql = "SELECT respuesta from respuestas_cuartoEscalon where pregunta = '$pregunta'  order by rand()" ;
    $result = $conn->query($sql);
   ...
   <a  style="text-decoration:none" class= "display-6 text-white" align="center" href="../../public">Retirarse o Quedarse con 200$</a> 
</button> <br> <br>
 ...
 <!-- Respuesta correcta -->   
<?php
    $sql = "SELECT respuesta from preguntas_cuartoEscalon where nombre LIKE '$pregunta'";
    $result = $conn->query($sql);
    while ($row = $result->fetch_assoc()) {
